...
#include <string.h>
#include <esp_log.h>
#include "rom/ets_sys.h"                //adicionada v6.1
// Definir el pin GPIO para el ADC
// Configurar el ancho de bits y la atenuación del canal ADC
#define DEFAULT_VREF    1100        // Valor predeterminado del voltaje de referencia del ADC (mV)
